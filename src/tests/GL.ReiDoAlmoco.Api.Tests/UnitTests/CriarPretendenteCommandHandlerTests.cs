...
{
    public class CriarPretendenteCommandHandlerTests : PretendenteCommandHandlerTests
    {
        [Fact(DisplayName = "CriarPretendenterCommand Handler - retorna sucesso quando conseguir criar o pretendente")]
        ...
        [Fact(DisplayName = "CriarPretendenterCommand Handler - retorna erro quando e-mail já existente")]
