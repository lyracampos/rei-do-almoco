...
{
    public class EditarPretendenteCommandHandlerTests : PretendenteCommandHandlerTests
    {
        [Fact(DisplayName = "EditarPretendenterCommand Handler - retorna sucesso quando conseguir editar os dados do pretendente")]
        ...
        [Fact(DisplayName = "EditarPretendenterCommand Handler - retorna erro quando não encontrar pretendente na base")]
