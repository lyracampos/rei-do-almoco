...
{
    public class RemoverPretendenteCommandHandlerTests : PretendenteCommandHandlerTests
    {
        [Fact(DisplayName = "RemoverPretendenterCommand Handler - retorna sucesso quando conseguir remover o pretendente")]
        ...
        [Fact(DisplayName = "RemoverPretendenterCommand Handler - retorna erro quando não encontrar pretendente na base")]
